...
class PreciosTab(QWidget):
    ...
    def _load_products(self):
        ...
        # Force a cache reload so newly updated prices are immediately available
        enable_cache(force=True)
    ...
    def _on_recalc_clicked(self):
        ...
        self._save_gain()
        # Recargamos completamente los productos para refrescar precios
        self._load_products()
